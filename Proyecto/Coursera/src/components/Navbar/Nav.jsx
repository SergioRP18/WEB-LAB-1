    ...
    return(
            <nav>
                <div className="nav-top">
                    <ul>
                        <li>For <strong>Individuals</strong></li>
                        <li>For <strong>Businesses</strong></li>
                        <li>For <strong>Universities</strong></li>
                        <li>For <strong>Governments</strong></li>
                    </ul>
                </div>
                <div className="nav-buttom">
                    <ul>
                        ...
                        <li><input type="text" placeholder="Waht do you want to learn"/><button><img src="#" alt="" /></button></li>
