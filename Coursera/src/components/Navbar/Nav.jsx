    ...
    return(
            <nav>
                <div className="nav-top">
                    <ul>
                        <a href="#"><li>For Individuals</li></a>
                        <a href="#"><li>For Businesses</li></a>
                        <a href="#"><li>For Universities</li></a>
                        <a href="#"><li>For Governments</li></a>
                    </ul>
                </div>
                <div className="nav-buttom">
                    <div className="left">
                        <ul>
                            ...
                            <li><Button2 txtbutton2="Explore"/></li>
                            <li><input type="text" placeholder="Waht do you want to learn"/></li>
                        </ul>
                    </div>
                    <div className="right">
                        <ul>
                            <li><p>Online Degrees</p></li>
                            <li><p>careers</p></li>
                            <li><p>Log In</p></li>
